...
<body>
<form name="f1" method="Post" action="markreentry1.php">
...
<tr>
<td align="center"><b><font color="#0033CC" size="4" face="Arial, Helvetica, sans-serif">Student ReMark Entry </b></font>
</td>
</tr>
<tr>
...
if (is_array(@$_POST["regno"])) {
    ...
    foreach( @$_POST["regno"] as $regno ) 
	{
		...
		$atten = mysql_real_escape_string( @$_POST["attendence"][$regno] );
         $update = " UPDATE `examtable` SET `reexam` = '$mark' ,reexamattendence='$atten'  WHERE `regno` =$regno LIMIT 1 ; ";
...
$updatestatus = " UPDATE `examtable` SET `reexamstatus` = 'fail' WHERE  reexam <= '49' and `regno` =$regno ";
mysql_query( $updatestatus );
					
$updatestatus = " UPDATE `examtable` SET `reexamstatus` = 'pass' WHERE reexam > '49' and `regno` =$regno ";
mysql_query( $updatestatus );	
...
/*$updategrade = " UPDATE `examtable` SET `reexamgrade` = 'U'  WHERE reexam <= '49' and `regno` =$regno";
mysql_query( $updategrade );
		
  $updategrade = " UPDATE `examtable` SET `reexamgrade` = 'D' WHERE reexam <= '59' AND reexam >=50 and `regno` =$regno ";
	 mysql_query( $updategrade );
		
  $updategrade = " UPDATE `examtable` SET `reexamgrade` = 'C'  WHERE reexam <= '69' AND reexam >=60 and `regno` =$regno ";
	 mysql_query( $updategrade );
  $updategrade = " UPDATE `examtable` SET `reexamgrade` = 'B'  WHERE reexam <= '79' AND mark >=70 and `regno` =$regno";
	 mysql_query( $updategrade );
		
  $updategrade = " UPDATE `examtable` SET `reexamgrade` = 'A'  WHERE reexam <= '89' AND reexam >=80 `regno` =$regno ";
	 mysql_query( $updategrade );
		
  $updategrade = " UPDATE `examtable` SET `reexamgrade` = 'S' WHERE reexam <= '100' AND reexam >=90 `regno` =$regno ";
	 mysql_query( $updategrade );*/
...
$sql = "select regno,name,sub,dept FROM examtable where semester='$sem' and section ='$section' and sub='$subject' and status='fail' and reexamgrade='NA' and  reexamattendence='NA' and reexamstatus='NA'";
$res = mysql_query( $sql ) or die( mysql_error() );
$sqlname= " select regno,name,sub,dept FROM examtable where semester='$sem' and section ='$section' and sub ='$subject' and status='fail' and reexamgrade='NA' and  reexamattendence='NA' and reexamstatus='NA' ";
...
<tr>
<td height="300px">
<font color="#0066FF"><center><h3> Student Re-entry Mark </h3></center></font>
