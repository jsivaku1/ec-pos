...
<body>
<form name="f1" method="Post" action="markentry.php">
...
<tr>
<td align="center"><b><font color="#0033CC" size="4" face="Arial, Helvetica, sans-serif">Student Mark List Entry </b></font>
</td>
</tr>
<tr>
...
if (is_array(@$_POST["regno"])) {
    ...
    foreach( @$_POST["regno"] as $regno ) 
	{
		...
		$atten = mysql_real_escape_string( @$_POST["attendence"][$regno] );
         $update = " UPDATE `examtable` SET `mark` = '$mark'   WHERE `regno` =$regno LIMIT 1 ; ";
