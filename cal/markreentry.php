...
<body>
<form name="f1" method="Post" action="markreentry.php">
...
$sql = "select regno,name,sub,dept FROM examtable where semester='$sem' and section ='$section' and sub='$subject' and status='fail' ";
$res = mysql_query( $sql ) or die( mysql_error() );
$sqlname= " select regno,name,sub,dept FROM examtable where semester='$sem' and section ='$section' and sub ='$subject' and status='fail'  ";
